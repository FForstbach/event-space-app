...
venues = Venue.create([{
  ...
  user_id: 7, name: "Work with style",
  ...
  user_id: 9, name: "Corporate uncreativity",
  ...
  user_id: 8, name: "Creativity festival",
  ...
  user_id: 8, name: "Show what you got",
  ...
  user_id: 8, name: "Chill and Grill",
