...
venues = Venue.create([{
  ...
  user_id: User.first.id, name: "Fusion Factory",
  ...
  user_id: User.first.id, name: "Pandem",
  ...
  user_id: User.first.id, name: "Caracalla",
  ...
  user_id: User.first.id, name: "Hell's Garden",
  ...
  user_id: User.first.id, name: "Bar of sins",
  ...
  user_id: User.first.id, name: "Work with style",
  ...
  user_id: User.last.id, name: "Nightlife",
  ...
  user_id: User.last.id, name: "Corporate uncreativity",
  ...
  user_id: User.last.id, name: "Creativity festival",
  ...
  user_id: User.last.id, name: "Show what you got",
  ...
  user_id: User.last.id, name: "Chill and Grill",
